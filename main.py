...
if __name__ == '__main__':
    ...
    parser.add_argument('--labels_path', type=str, default="data/raw/synthetic/label.txt")
    ...
    parser.add_argument('--shrinked_network_size', type=int, default=4000)
    ...
    parser.add_argument('--synthetic', type=bool, default=True)
